package com.bank.bian.directdebitmandate.model;
...
/**
 * The BIAN control record for this service domain: "Direct Debit Mandate Management Plan".
 *
 ...
 * to its asset type (Direct Debit Mandate). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Direct Debit Mandate Management Plan";
